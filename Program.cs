...
namespace Exercise
{
    internal class Program
    {
        ...
        //Queue
        //דף עבודה: תרגילי חזרה על מחסנית
        //Q3
        ...
        //O(n^2)
        //Q4
        //A function that gets a queue q and an int x and returns the number of series with the length of x
        ...
        static void Main(string[] args)
        {
            ...
            BinNode<int> Tree = new BinNode<int>(1, new BinNode<int>(-8, new BinNode<int>(-4), new BinNode<int>(-12)), new BinNode<int>(-2, new BinNode<int>(-234), new BinNode<int>(-4567)));

            //Console.WriteLine(IsOneInSec(stak, stak2));
            Console.WriteLine(IsPolindrom(q));
            PrintLeftSons(Tree);
            //Console.WriteLine(MoreThanOnce(q));
            Console.ReadLine();
        }
    }
}
